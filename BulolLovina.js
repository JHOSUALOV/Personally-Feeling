...
// Dirubah 
const pengirim = "Pecundang Terhebat";
const nomorWa = "6281381625397"; // awalan nomor 0 harus di awalin 62
const textWa = "Apa yang mau kamu lakukan untukku setelah ini, Jho? (Tolong kirim pesan ini, Lov. Aku ingin memberikanmu sesuatu yang menarik"
const pesan = `apapun awalan hurufmu, tetap dirimulah awal mula kesenangan dan kejayaanku dalam hidup. Maafkan atas segala tindak kriminal dan kejahatan kepadamu. Aku tidak pandai merangkai kata, tapi (pada akhirnya) aku hanya ingin mengungkapkan perasaanku dengan cara yang keren dan berkesan. Aku sayang sekali padamu Lov, sayang dan sayang sekali. Sebagai penutup, aku akan menutup ini dengan mengakui bahwa dirimu adalah Mary Austin untuk hidupku. Namun untuk akhir cerita, aku akan tetap *mendambakan kehidupan bersamamu*. (Aku ngoding ini dengan tetesan air mataku, Lov) `;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Halo, aku ingin mengenalmu Lov, boleh tidak?',
    html: `<input type="text" id="login" class="swal2-input" placeholder="Vinzra? Lovi? Lop? Vyn?">`,
    confirmButtonText: 'Kirim',
    focusConfirm: false,
    preConfirm: () => {
      const login = Swal.getPopup().querySelector('#login').value
      if (!login) {
        Swal.showValidationMessage(`Tulis namamu dong, aku ingin mengenalmu :(`)
      }
      return { login }
    }
  }).then((result) => {
    ...
    let txt = `Halo, nama kamu ${result.value.login} ya, nama kamu berawal dari huruf ${namaAwal.toUpperCase()} tau, tapi ${pesan}`;
